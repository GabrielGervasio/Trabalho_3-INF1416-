...
public class DatabaseInitializer {
    ...
    public static void initializeMessages() {
        ...
        String sql = "INSERT OR IGNORE INTO Mensagens (MID, texto_mensagem) VALUES (?, ?)";
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            System.out.println("✅ Mensagens inseridas: " + results.length + " registros");
    ...
    public static void initializeGroups() {
        String sql = "INSERT OR IGNORE INTO Grupos (GID, nome_grupo) VALUES (1, 'Administrador'), (2, 'Usuario')";
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            System.err.println("Erro ao inserir grupos: " + e.getMessage());
        }
    }
}