-- Apagar tabela teste se quiser (opcional)
...
CREATE TABLE IF NOT EXISTS Chaveiro (
    ...
    chave_privada_bin BLOB NOT NULL
);
...
CREATE TABLE IF NOT EXISTS Registros (
    ...
    UID INTEGER,
    arq_name VARCHAR(255),
    FOREIGN KEY (MID) REFERENCES Mensagens(MID),
    FOREIGN KEY (UID) REFERENCES Usuarios(UID)
);

-- Inserir grupos padrão
INSERT OR IGNORE INTO Grupos (GID, nome_grupo) VALUES (1, 'Administrador');
INSERT OR IGNORE INTO Grupos (GID, nome_grupo) VALUES (2, 'Usuario');

-- Inserir mensagens
INSERT OR IGNORE INTO Mensagens (MID, texto_mensagem) VALUES
